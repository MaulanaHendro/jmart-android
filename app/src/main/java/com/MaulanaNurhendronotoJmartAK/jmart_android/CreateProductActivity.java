...
import com.MaulanaNurhendronotoJmartAK.jmart_android.model.Product;
import com.MaulanaNurhendronotoJmartAK.jmart_android.request.CreateProductRequest;
 ...
 * display for creating new product
 *
...
public class CreateProductActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        CheckBox newCheck = (CheckBox) findViewById(R.id.new_createProductActivity);
        CheckBox usedCheck = (CheckBox) findViewById(R.id.used_createProductActivity);
        ...
        Button createButton = (Button) findViewById(R.id.createButton_createProductActivity);
        Button clearButton = (Button) findViewById(R.id.cancelButton_createProductActivity);
                ...
                Response.Listener<String> listener = new Response.Listener<String>()
                {
                    ...
                    public void onResponse(String response)
                    {
                        try
                        {
                            ...
                            Toast.makeText(CreateProductActivity.this,"Product added",Toast.LENGTH_SHORT).show();
                        }
                        catch (JSONException e)
                        {
                            Toast.makeText(CreateProductActivity.this,"Product not added",Toast.LENGTH_SHORT).show();
                            e.printStackTrace();
                        }
